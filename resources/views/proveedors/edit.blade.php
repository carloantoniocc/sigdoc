...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-10 col-lg-offset-1 col-md-12">
			...
			<!--FIN BreadCrumb-->
			<!--Panel Formulario Editar Proveedor-->
			<div class="panel panel-default">
                <div class="panel-heading">Editar Proveedor</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ URL::to('proveedors') }}/{{$proveedor->id}}">
                        ...
                        <div class="form-group{{ $errors->has('run') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="run" type="text" class="form-control" name="run" value="{{$proveedor->rut}}-{{$proveedor->dv}}" onchange="validaRut()" readonly>
						...
						<!--Elementos ocultos-->
						<input name="rut" id="rut" type="hidden" value="{{$proveedor->rut}}">
						<input name="dv" id="dv" type="hidden" value="{{$proveedor->dv}}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="name" value="{{$proveedor->name}}" maxlength="150" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('fantasia') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="fantasia" type="text" class="form-control" name="fantasia" value="{{$proveedor->fantasia}}" maxlength="150" autofocus>
                            ...
                            <div class="col-md-6">
								<select id="comuna" class="form-control" name="comuna" required>
									...
									@foreach($comunas as $comuna)
										@if($comuna->id == $proveedor->comuna_id)
                        ...
                        <div class="form-group{{ $errors->has('direccion') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="direccion" type="text" class="form-control" name="direccion" value="{{ $proveedor->direccion }}" onFocus="geolocate()" maxlength="150" required autofocus>
						...
						<!--Elementos ocultos-->
						<input name="x" id="x" type="hidden" value="{{ $proveedor->X }}">
						<input name="y" id="y" type="hidden" value="{{ $proveedor->Y }}">
						<!--Campo Telefono-->
                        <div class="form-group{{ $errors->has('telefono') ? ' has-error' : '' }}">
                            <label for="telefono" class="col-md-4 control-label">Teléfono</label>

                            <div class="col-md-6">
                                <input id="telefono" type="text" class="form-control" name="telefono" value="{{ $proveedor->telefono }}" maxlength="11" pattern="[0-9]+" placeholder="sólo numeros" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control" name="email" value="{{ $proveedor->email }}" maxlength="150" autofocus>
