...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
			...
			<!--FIN BreadCrumb-->
			<!--Panel Formulario Crear Clasificador-->
			<div class="panel panel-default">
                <div class="panel-heading">Crear Clasificador</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ URL::to('clasificadors') }}">
                        {{ csrf_field() }}
						<!--Campo Codigo-->
			...
			<!--FIN Panel Formulario Crear Clasificadores-->
        </div>
    </div>
</div>
@endsection
