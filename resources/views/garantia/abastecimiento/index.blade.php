                ...
                <div class="panel-body">
					...
					<div class="row">					
						...
						<div class="col-md-3 col-md-offset-3">
							<form class="form-horizontal" role="form" method="GET" action="{{ URL::to('garantias/abastecimiento') }}">
								  ...
								  <tr>
									...
									<td>
										@if( $garantia->estado == 'NP' )
											<a href="{{ URL::to('garantias/abastecimiento/' . $garantia->id . '/edit/3') }}">Editar</a>       <br>										
											<a href="{{ URL::to('garantias/abastecimiento/' . $garantia->id . '/rechazar/3') }}">Rechazar</a> <br>
										@endif	
										<a href="{{ URL::to('garantias/abastecimiento/' . $garantia->id . '/renovar/3') }}">Renovar</a>  <br>
										<a href="{{ URL::to('garantias/abastecimiento/' . $garantia->id . '/enviar/3') }}">Enviar</a> 
									</td>
								  </tr>
								  @endforeach
								</tbody>
