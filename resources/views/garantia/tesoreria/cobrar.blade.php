    ...
    <div class="row">
        <div class="col-lg-10 col-lg-offset-1 col-md-12">
			...
			<div class="panel panel-default">
                <div class="panel-heading">Cobro de Documentos de Garantia</div>
                <div class="panel-body">
					...
					<div class="row">	
						<div class="col-md-10 col-md-offset-1">
							<form class="form-horizontal" role="form" method="POST" action="{{ URL::to('garantias/cobrar') }}">
								{{ csrf_field() }}
								<!--RUT-->
								<div class="form-group{{ $errors->has('rut') ? ' has-error' : '' }}">
									<label for="rut" class="col-md-3 control-label">R.U.N. de quien cobra</label>
									<div class="col-md-6">
								...
								<div class="form-group{{ $errors->has('nombre') ? ' has-error' : '' }}">
									<label for="nombre" class="col-md-3 control-label">Nombre de quien cobra</label>
									<div class="col-md-6">
								...
								<div class="form-group{{ $errors->has('fechaEntrega') ? ' has-error' : '' }}">
									<label for="fecha" class="col-md-3 control-label">Fecha de cobro</label>
									<div class="col-md-6">
