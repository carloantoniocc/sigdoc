    ...
    <div class="row">
        <div class="col-lg-10 col-lg-offset-1 col-md-12">
			...
			<div class="panel panel-default">
                <div class="panel-heading">Devolver Documentos a Referente Técnico</div>
                <div class="panel-body">
					...
					<div class="row">	
						<div class="col-md-10 col-md-offset-1">
							<form role="form" method="POST" action="{{ URL::to('jefeReferenteTecnico/devolver') }}">
								{{ csrf_field() }}
								<!--Campo Nombre-->
								<div class="form-group">
									<label for="name" class="control-label">Observacion de Devolución (En caso de Observaciones)</label>
