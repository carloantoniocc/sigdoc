...
<div class="container-fluid">
	...
	@elseif($message == 'envio')
		<div class="alert alert-success alert-dismissible" role="alert">
			<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			Se Han Enviado el Documento a Contabilidad
		</div>		
	@endif
    ...
    <div class="row">
        <div class="col-lg-10 col-lg-offset-1 col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">Documentos con Vistos Buenos</div>
                <div class="panel-body">
					<!-- row Busquedas -->
					<div class="row">						
						<!-- Filtro de Numero de Documento -->
						<form class="form-horizontal" role="form" method="GET" action="{{ URL::to('oficinaConvenios/validados') }}">
							<div class="col-md-3">
							...
							<div class="col-md-3">
								<div class="input-group">
									<select id="searchReferente" class="form-control input-sm" name="searchReferente" style="width:100%">
					...
					<!-- Lista de Documentos -->		
					<div class="row">
						<form class="form-horizontal" role="form" method="POST" action="{{ URL::to('oficinaConvenios/validados') }}">
							{{ csrf_field() }} 
							<div class="col-md-12">
								<table class="table table-striped">
									...
									<tbody>
									  ...
									  <tr>
										...
										<td>{{ $documento->fechaValidacion }}</td>
										<td>
											@if( $documento->estado == 'RC' )
										...
										@endif
										<td>
											<a href="{{ URL::to('oficinaConvenios/' . $documento->id . '/validadores') }}" title="Revisar Validadores">Validadores</a> 
											<br>		
											<a href="{{ URL::to('oficinaConvenios/' . $documento->id . '/devolver') }}" title="Devolver a Referente Técnico">Devolver</a> 
										</td>
									  </tr>
									  @endforeach
									</tbody>
