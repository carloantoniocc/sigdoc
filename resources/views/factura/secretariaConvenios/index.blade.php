...
<div class="container-fluid">
	...
	@elseif($message == 'envioWarning')
		<div class="alert alert-warning alert-dismissible" role="alert">
			<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			Documentos sin archivo adjunto o sin orden de compra no han sido enviados
		</div>		
	@endif
    ...
    <div class="row">
        <div class="col-lg-10 col-lg-offset-1 col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">Recepción Secretaría de Convenios</div>
                <div class="panel-body">
					<!-- row Busquedas -->
					<div class="row">						
						<!-- Filtro de Numero de Documento -->
						<form class="form-horizontal" role="form" method="GET" action="{{ URL::to('secretariaConvenios') }}">
					...
					<!-- Lista de Documentos -->		
					<div class="row">
						<form class="form-horizontal" role="form" method="POST" action="{{ URL::to('secretariaConvenios/enviar') }}">
							{{ csrf_field() }} 
							<div class="col-md-12">
								<table class="table table-striped">
									...
									<tbody>
									  ...
									  <tr>
										...
										@endif
										<td>
											<a href="{{ URL::to('secretariaConvenios/' . $documento->id . '/edit/2') }}">Editar</a> | 
											<a href="{{ URL::to('secretariaConvenios/' . $documento->id . '/rechazar/2') }}">Rechazar</a>
										</td>
									  </tr>
									  @endforeach
									</tbody>
